...
def extract_agieval_gaokao_mathcloze_cot_test(question, reasoning, task):
    ans = extract_boxed_answers(reasoning)
    ans = [_.strip("$") for _ in ans]
    return ans

def extract_agieval_gaokao_mathqa_cot_test(question, reasoning, task):
    ans = extract_boxed_answers(reasoning)
